...
export const skillsSection = {
    ...
    content: `<p className="text-hitam text-xl sm:text-2xl md:text-4xl font-bold dark:text-background">
    Skills & Tools</p>`
}

export const marqueeList = [
    {
        svg: `<div className="ml-7 md:ml-20">
        <svg className="w-10 h-10 md:w-24 md:h-24 filter grayscale hover:grayscale-0 transition ease-in-out duration-300" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
...
export const imgList = [
    ...
    },
    {
      ...
      },
      {
        img: (
            //LARAVEL
            <svg className="w-10 h-10 md:w-24 md:h-24 filter grayscale hover:grayscale-0 transition ease-in-out duration-300" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 256 264">
      ...
      },
      {
        img: (
            //REACT
            <svg className="w-10 h-10 md:w-24 md:h-24  filter grayscale hover:grayscale-0 transition ease-in-out duration-300" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 256 228">
      ...
      },
      {
        img: (
            //Nodejs
            <svg className="w-10 h-10 md:w-24 md:h-24 filter grayscale hover:grayscale-0 transition ease-in-out duration-300" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 256 384">
