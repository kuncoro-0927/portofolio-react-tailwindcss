      ...
      <header className="bg-background dark:bg-hitam py-20 md:py-44">
        <div className="md:flex items-start"> {/* Aligns items to the start */}
          <div className="mx-10 md:mx-10 lg:mx-28 mt-10 md:mr-auto">
            <p className="text-sm text-hitam sm:text-4xl md:text-2xl lg:text-4xl dark:text-background font-space">
              Hi, I`m <span className="font-semibold md:text-2xl sm:text-4xl lg:text-4xl dark:text-background">Khitan Hesthi Kuncoro</span> 
            </p>
            <p className="text-sm mt-3 sm:text-4xl text-kuning font-semibold md:text-2xl lg:text-4xl">
              Full Stack Web Developer.
            </p>
            <p className="text-sm sm:text-4xl text-hitam mt-3 font-semibold md:text-2xl dark:text-background">
              Let`s Connect!
            </p>
          ...
          {/* Image section */}
          <div className="w-72 mx-auto md: md:mr-10 lg:mr-36 sm:w-96 sm:mx-auto md:w-96 lg:w-96 mt-10 md:mt-0"> {/* Add margin-top for spacing on small screens */}
            <img src="/src/profile.svg" className="" alt="Profile" />
          </div>
        </div>
      </header>
    </>
